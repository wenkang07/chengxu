function [OmegaVal,Omegaval1,Omegaval2,Omegaval3,Omegaval4,Omegaval5]=LMIksepoint(C,h,mu,kappa,barDelta,delta,delta1)
...
%% Solution of LMIs
LMIs=[lambda1>=0,lambda2>=0,beta1>=0,beta2>=0,beta3>=0,p1>=0, p2>=0,eta>=0,r>=0,Gamma>=0, Theta2>=0, Theta1>=0, Theta3<=0, Theta4<=0, Theta5<=0,Theta6<=0,Theta7<=0,Theta8<=0]; 
