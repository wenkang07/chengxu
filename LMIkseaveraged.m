function [OmegaVal,Omegaval1,Omegaval2,Omegaval3,Omegaval4,Omegaval5]=LMIkseaveraged(C,h,mu,kappa,barDelta,delta)
...
%% The LMI for Theta1(3.21)
Theta1=blkvar; 
Theta1(1,1)=p1-1-Gamma;
Theta1=sdpvar(Theta1);
%% The LMI with Theta2(3.21)
Theta2=blkvar; 
Theta2(1,1)=p2-(1+Gamma)*1/(pi^2);
Theta2(1,2)=sqrt(1/(pi^2)+1/2);
Theta2(2,2)=Gamma;
Theta2=sdpvar(Theta2);
%% The LMI for Theta3(3.22)
Theta3=blkvar;
...
%% Solution of LMIs
LMIs=[lambda1>=0,lambda2>=0,p1>=0, p2>=0,r>=0,Gamma>=0, Theta2>=0, Theta1>=0, Theta3<=0, Theta4<=0, Theta5<=0,Theta6<=0]; 
